...
if ($_SESSION['usuario_valido']!="")
  ...
  <?PHP
         $in2 = "select id_tarea from tareaxcliente where id_cliente=".$cu." " ;
...
if (isset($_POST['submit'])) {
			...
			foreach($_POST['check_list'] as $selected){
				$in2 = "delete from tareaxcliente where id_cliente='$cuit'"."and id_tarea='$selected'" ;
		...
		echo '<script language="javascript">alert("Se han eliminado las obligaciones con exito");window.location.href="tareas.php"</script>';
